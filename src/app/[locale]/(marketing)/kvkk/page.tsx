...
export default async function KvkkPage({ params }: PageProps) {
  ...
  const sections = [
    { title: t("kvkk.section1Title"), content: t("kvkk.section1Content") },
    { title: t("kvkk.section2Title"), content: t("kvkk.section2Content") },
    { title: t("kvkk.section3Title"), content: t("kvkk.section3Content") },
    { title: t("kvkk.section4Title"), content: t("kvkk.section4Content") },
