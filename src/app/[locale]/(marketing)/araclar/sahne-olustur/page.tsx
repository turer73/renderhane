  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-5xl px-4">
        {/* Ad Slot — Hero */}
        <AdSlot slot="scene-hero" format="horizontal" className="mb-8 mt-8" />
        ...
        {/* Ad Slot — Mid */}
        <AdSlot slot="scene-mid" format="horizontal" className="mb-8" />
        ...
        {/* Ad Slot — Bottom */}
        <AdSlot slot="scene-bottom" format="horizontal" className="mb-12" />
