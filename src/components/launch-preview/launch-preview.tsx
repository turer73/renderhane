...
export function LaunchPreview({locale}:{locale:Locale}) {
  ...
  return <div className="rhl">
    ...
    <div className="rhl-shell">
      ...
      <LaunchPreviewSections locale={locale}/>
