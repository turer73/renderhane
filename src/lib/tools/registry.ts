...
export const TOOLS: ToolDefinition[] = [
  // ── Mevcut Araçlar (6) ──────────────────────
  {
    ...
    href: "/app/workspace?tool=bg-remove",
    ready: true,
  ...
  // ── Yeni Araçlar (6) ───────────────────────
  {
    ...
    inputType: "image-text",
    segments: ["ecommerce", "gaming", "3dprint"],
    href: "/app/workspace?tool=image-edit",
    ready: true,
  ...
  },
  {
    ...
    inputType: "multi-image",
    segments: ["ecommerce"],
    href: "/app/workspace?tool=virtual-tryon",
    ready: true,
